  ...
  public SignValue evaluate(
    ...
    switch (pOperation) {
      case ADD:
        ...
        if (pLHS ==  SignValue.MINUS && pRHS == SignValue.PLUS || pLHS ==  SignValue.MINUS && pRHS == SignValue.ZERO_PLUS || pLHS ==  SignValue.MINUS && pRHS == SignValue.TOP) return SignValue.TOP;
